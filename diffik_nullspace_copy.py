...
def main() -> None:
    ...
    model = mujoco.MjModel.from_xml_path("/home/mtronlab/priyansh/mujoco/xarm_mujocomodel/ufactory_xarm7/scene_strike_act.xml")
    ...
    # Define waypoints
    waypoints = [
    np.array([0.3, 0, 0.30]),   # Initial position (or another suitable starting point)
    np.array([0.4, 0, 0.30]), # Move 10 cm along the x-axis
